    ...
    <section className="section-padding bg-[#1E3A5F]">
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <span className="text-[#FF5722] font-semibold text-sm uppercase tracking-wider">Testimonials</span>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-2xl relative">
            ...
            <div className="flex gap-1 mb-4">
              {[...Array(5)].map((_, i) => (
                <svg key={i} className="w-5 h-5 text-[#FF5722]" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[#FF5722] text-sm font-medium">{testimonials[activeIndex].service}</p>
              </div>
              ...
              <div className="flex gap-2">
                <button 
                  ...
                  className="w-10 h-10 rounded-full border-2 border-gray-200 flex items-center justify-center hover:border-[#FF5722] hover:text-[#FF5722] transition-colors"
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-colors ${
                    index === activeIndex ? 'bg-[#FF5722]' : 'bg-gray-300'
                  }`}
        ...
        <div className="text-center mt-8">
          <a href="#" className="inline-flex items-center gap-2 text-white hover:text-[#FF5722] transition-colors">
