    ...
    <section id="service-areas" className="section-padding bg-white">
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <span className="text-[#FF5722] font-semibold text-sm uppercase tracking-wider">Where We Work</span>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-gray-100 rounded-2xl p-8 h-full min-h-[400px] flex items-center justify-center">
            <div className="text-center">
              <div className="w-20 h-20 bg-[#FF5722]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-10 h-10 text-[#FF5722]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div key={county.name} className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {county.towns.map((town) => (
                    <span 
                      key={town}
                      className="bg-white px-3 py-1.5 rounded-full text-sm text-gray-700 border border-gray-200 hover:border-[#FF5722] hover:text-[#FF5722] transition-colors cursor-default"
                    >
                      {town}
                    </span>
                  ))}
        ...
        <div className="mt-12 text-center">
          ...
          <a href="#contact" className="bg-[#FF5722] hover:bg-[#E64A19] text-white font-heading font-semibold px-6 py-3 rounded-lg transition-colors inline-block">
