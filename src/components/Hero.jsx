    ...
    <section className="relative bg-dark-900 min-h-[600px] md:min-h-[700px] flex items-center">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-2xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-[#F7941D]/20 border border-[#F7941D]/30 rounded-full px-4 py-2 mb-6">
            <span className="w-2 h-2 bg-[#F7941D] rounded-full animate-pulse"></span>
            <span className="text-[#F7941D] text-sm font-medium">Trusted NY Metro Contractor Since 2005</span>
          </div>

          {/* Heading */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-white mb-6 leading-tight">
            Quality Home Improvements You Can 
            <span className="text-[#F7941D]"> Trust</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="#contact" className="bg-[#F7941D] hover:bg-[#e8850f] text-white font-heading font-semibold text-lg px-8 py-4 rounded-lg transition-colors text-center">
