        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <span className="font-heading font-bold text-lg text-white">Construction</span>
              </div>
            </div>
            <p className="text-gray-400 mb-4">
              Professional home improvement services in New Jersey. Quality craftsmanship, reliable service, and customer satisfaction guaranteed.
            </p>
            <div className="flex gap-4">
              ...
              <a href="#" className="text-gray-400 hover:text-primary-400 transition-colors" aria-label="Google">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {serviceAreas.map((area) => (
                <li key={area}>
                  <a href="/#service-areas" className="text-gray-400 hover:text-primary-400 transition-colors">
                    {area}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400">123 Main Street<br />Edison, NJ 08817</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+17325551234" className="text-gray-400 hover:text-primary-400 transition-colors">
                  (732) 555-1234
                </a>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@123ccm.com" className="text-gray-400 hover:text-primary-400 transition-colors">
                  info@123ccm.com
                </a>
              </li>
            </ul>
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">
              © {new Date().getFullYear()} CCM Construction. All rights reserved.
            </p>
