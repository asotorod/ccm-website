    ...
    <section id="about" className="section-padding bg-gray-50">
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Content Side */}
          <div>
            <span className="text-primary-600 font-semibold text-sm uppercase tracking-wider">About CCM</span>
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-dark-900 mt-2 mb-6">
              Building Trust, One Home at a Time
            </h2>
            <p className="text-gray-600 text-lg mb-6">
              Since 2005, CCM Construction has been Central New Jersey's trusted choice for quality home improvements. 
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              {stats.map((stat) => (
                <div key={stat.label} className="text-center p-4 bg-white rounded-xl shadow-sm">
                  <p className="text-2xl md:text-3xl font-heading font-bold text-primary-600">{stat.number}</p>
